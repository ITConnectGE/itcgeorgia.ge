    ...
    <>
      ...
      <section className="py-16 sm:py-20 border-b border-slate-100">
        <div className="mx-auto max-w-5xl px-5">
          <div className="max-w-2xl">
            <p className="text-xs font-semibold uppercase tracking-wider text-navy-600 mb-2">სერვისები</p>
        ...
        <section key={service.id} id={service.id} className={`py-20 sm:py-24 ${index % 2 === 1 ? "bg-slate-50" : ""}`}>
          <div className="mx-auto max-w-5xl px-5">
            <div className="max-w-2xl mb-10">
              <p className="text-xs font-semibold uppercase tracking-wider text-navy-600 mb-2">{service.vendor}</p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-10">
              {service.products.map((p) => (
                <div key={p.name} className="bg-white border border-slate-200 rounded-xl p-6">
                  <h3 className="text-sm font-semibold text-slate-900 mb-1.5">{p.name}</h3>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 bg-slate-50 rounded-xl p-6 mb-8">
              <div>
                <h4 className="text-sm font-semibold text-slate-900 mb-1">ვისთვისაა</h4>
                <p className="text-sm text-slate-500 leading-relaxed">{service.audience}</p>
              </div>
              <div>
                <h4 className="text-sm font-semibold text-slate-900 mb-1">როგორ გეხმარებით</h4>
                <p className="text-sm text-slate-500 leading-relaxed">{service.help}</p>
              </div>
            </div>
      ...
      <section id="consulting" className="py-20 sm:py-24 bg-navy-900">
        <div className="mx-auto max-w-5xl px-5">
          <div className="text-center max-w-2xl mx-auto mb-12">
            <p className="text-xs font-semibold uppercase tracking-wider text-navy-400 mb-2">დამატებითი სერვისები</p>
      ...
      <section className="py-16 bg-white">
        <div className="mx-auto max-w-5xl px-5 text-center">
          ...
          <p className="mt-2 text-sm text-slate-500">მოგვწერეთ — მოგამზადებთ პერსონალიზებულ შეთავაზებას.</p>
          <div className="mt-6">
            <Link href="/contact" className="px-5 py-2.5 text-sm font-medium text-white bg-navy-900 rounded-lg hover:bg-navy-800 transition-colors">
