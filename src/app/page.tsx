    ...
    <>
      ...
      <section className="pt-28 pb-20 sm:pt-36 sm:pb-28 bg-white">
        <div className="mx-auto max-w-[1280px] px-6">
          <div className="max-w-2xl">
            <p className="text-[13px] font-medium text-navy-600 mb-4">
              Microsoft &middot; AWS &middot; Google — ოფიციალური რესელერი
            </p>
            <h1 className="text-3xl sm:text-4xl lg:text-[42px] font-semibold text-slate-900 leading-[1.2] tracking-tight">
              პროგრამული ლიცენზიები და ღრუბლოვანი სერვისები საქართველოში
            </h1>
            <p className="mt-5 text-[16px] text-slate-500 leading-relaxed max-w-xl">
            ...
            <div className="mt-8 flex flex-wrap gap-3">
              ...
              <Link
                href="/services"
                className="px-5 py-2.5 text-[14px] font-medium text-slate-700 border border-slate-200 rounded-lg hover:bg-slate-50 transition-colors"
              >
                სერვისების ნახვა
              </Link>
            </div>
          ...
          {/* Trust bar */}
          <div className="mt-14 flex flex-wrap gap-6 text-[13px] text-slate-400">
        ...
        <div className="mx-auto max-w-[1280px] px-6">
          <div className="flex flex-wrap items-center justify-center gap-12 text-slate-300">
            {[
              ...
              <div key={p.name} className="flex items-center gap-2.5 hover:text-slate-500 transition-colors">
          ...
          <div className="mt-12 grid grid-cols-1 md:grid-cols-3 gap-6">
            {[
              ...
              >
                ...
                <Link
                  href={service.href}
                  className="text-[13px] font-medium text-navy-600 hover:text-navy-800 transition-colors"
                >
                  დეტალურად &rarr;
                </Link>
              </div>
      ...
      <section className="py-20 sm:py-24 bg-slate-50">
        <div className="mx-auto max-w-[1280px] px-6">
          <SectionHeading
            ...
            description="საერთაშორისო ვენდორისგან პირდაპირ შეძენის ნაცვლად, ITC Georgia-სთან თანამშრომლობა რეალურ ბიზნეს-სარგებელს მოგიტანთ."
          />
            ...
            {[
              {
                ...
                desc: "გადაიხადეთ ეროვნულ ვალუტაში — საბანკო საკომისიოს და ვალუტის კონვერტაციის გარეშე.",
              },
              {
                icon: "M19.5 14.25v-2.625a3.375 3.375 0 00-3.375-3.375h-1.5A1.125 1.125 0 0113.5 7.125v-1.5a3.375 3.375 0 00-3.375-3.375H8.25m0 12.75h7.5m-7.5 3H12M10.5 2.25H5.625c-.621 0-1.125.504-1.125 1.125v17.25c0 .621.504 1.125 1.125 1.125h12.75c.621 0 1.125-.504 1.125-1.125V11.25a9 9 0 00-9-9z",
                title: "დღგ-ს ჩათვლით ინვოისი",
                desc: "ქართული კანონმდებლობის შესაბამისი ანგარიშფაქტურა — ამარტივებს ბუღალტერიასა და აუდიტს.",
              },
              {
                ...
                desc: "ადგილობრივ წარმომადგენელთან ურთიერთობა ქართულად — სწრაფი და ნათელი.",
              },
              {
                icon: "M9.813 15.904L9 18.75l-.813-2.846a4.5 4.5 0 00-3.09-3.09L2.25 12l2.846-.813a4.5 4.5 0 003.09-3.09L9 5.25l.813 2.846a4.5 4.5 0 003.09 3.09L15.75 12l-2.846.813a4.5 4.5 0 00-3.09 3.09z",
                title: "კონსულტაცია",
                desc: "გეხმარებით სწორი პროდუქტისა და ლიცენზიის ტიპის შერჩევაში.",
              },
              {
                icon: "M9.879 7.519c1.171-1.025 3.071-1.025 4.242 0 1.172 1.025 1.172 2.687 0 3.712-.203.179-.43.326-.67.442-.745.361-1.45.999-1.45 1.827v.75M21 12a9 9 0 11-18 0 9 9 0 0118 0zm-9 5.25h.008v.008H12v-.008z",
                title: "L1 ტექნიკური მხარდაჭერა",
                desc: "პირველი დონის მხარდაჭერა ჩვენგან. ვენდორის სერვისიც ხელმისაწვდომია.",
              },
              {
                icon: "M3.75 13.5l10.5-11.25L12 10.5h8.25L9.75 21.75 12 13.5H3.75z",
                title: "მარტივი პროცესი",
                desc: "არანაირი საერთაშორისო ტრანზაქციები — მარტივი, სწრაფი შეძენა.",
              },
            ].map((b, i) => (
              <div key={i} className="bg-white border border-slate-200 rounded-xl p-6">
                <svg className="w-5 h-5 text-navy-600 mb-3" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
        ...
        <div className="mx-auto max-w-[1280px] px-6">
          ...
          <div className="mt-12 grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-6">
            {[
              ...
              { n: "03", title: "შეთავაზება", desc: "მიიღებთ ფასს ლარში, დღგ-ს ჩათვლით" },
              { n: "04", title: "შეძენა", desc: "ხელშეკრულება და ლიცენზიის აქტივაცია" },
              { n: "05", title: "მხარდაჭერა", desc: "უწყვეტი ტექნიკური მხარდაჭერა" },
            ].map((step) => (
              <div key={step.n} className="text-center">
                <span className="text-[28px] font-semibold text-slate-200">{step.n}</span>
                <h3 className="mt-1 text-[14px] font-semibold text-slate-900">{step.title}</h3>
                <p className="mt-1 text-[12px] text-slate-400 leading-relaxed">{step.desc}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-20 sm:py-24 bg-navy-900">
        <div className="mx-auto max-w-[1280px] px-6 text-center">
          ...
          <p className="mt-3 text-[15px] text-slate-400 max-w-md mx-auto">
            მოგვწერეთ ან დაგვირეკეთ — კონსულტაცია უფასოა.
          </p>
          <div className="mt-8 flex flex-wrap items-center justify-center gap-3">
            <Link
              href="/contact"
              className="px-5 py-2.5 text-[14px] font-medium text-navy-900 bg-white rounded-lg hover:bg-slate-100 transition-colors"
            >
              კონსულტაციის მოთხოვნა
            </Link>
            <Link
              href="tel:032244111"
              className="px-5 py-2.5 text-[14px] font-medium text-slate-300 border border-slate-600 rounded-lg hover:bg-white/5 transition-colors"
            >
              032 2 44 11 11
            </Link>
          </div>
